...
> **2026-07 公开更新 / 历史稿标注:** 这篇保留为最早公开 thesis 与自我纠错记录。文中的入门 / 中端 / Pro
> 档、9B / 27-70B、USB-C 盒子、Pro Cloud、价格等说法 **不是当前产品边界**。现在对外从 **C1** 开始:
> 0.1B / 0.3B / 1B / bounded 3B 常驻低比特推理, 先比同任务 tok/s / p99 latency / Hz / 闭环成功率,
> 再谈本地私密、功耗、可写入模型槽位。8B / 32B / 100B 仍是 C2/C3 可能性前沿研究, 不是第一 SKU 承诺。
...
我有一份兼职教练的收入, 已经舒服地超过了项目预算。多花点时间在上面, 加上真心 partner 互助、高校 / 校友 / sponsor 的贡献, 凑齐 2 年自费池 **~¥100 万 ($140K)** 烧一颗 5×5 mm² 28nm MPW test tile 不难。资金不是这个项目的难处, 芯片物理才是。
