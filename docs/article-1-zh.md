...
**Year-1 自费 ceiling**: ¥30-50K (Michael 多招学生, 这项目本身就在挣钱)。
**2 年总预算池**: 100 个 partner 围拢 + ¥60-100K 自费 + 学术/校友/sponsor = 一颗 small test tile 足够。

**我们不主动找投资人**。Reactive readiness only — 如果有基金主动来找而且真心想要这件事, 可以聊。我们永不写 cold pitch。
...
Email: <michaelhuo2030 on GitHub> | 微信: TBD | X: TBD
